...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/redis-server-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/redis-server-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add redis-server
# for installing globally
pixi global install redis-server
```
...
It is possible to list all of the versions of `redis-server` available on your platform:
...
```
pixi search redis-server --channel conda-forge
```
